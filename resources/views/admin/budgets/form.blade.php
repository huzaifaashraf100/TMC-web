...
<div id="content" class="main-content">
    <div class=" layout">
        <div class=" layout-top-spacing align-items-center col-12 col-md-12 col-sm-12 col-xl-12 d-flex mb-3 justify-content-between">
        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 layout-spacing">
            ...
            <div class="widget-content widget-content-area" style="overflow-x: auto; ">
                ...
                <form method="PUT" class="p-5" id="addform" enctype="multipart/form-data"
                    action="{{ route('admin.budget.update', ['id' => $data->id]) }}">
                    @method('PUT')
                    @else
                    <form method="POST" class="p-5" id="addform" enctype="multipart/form-data"
                        action="{{ route('admin.budget.create') }}">
                        @endif
                        @CSRF
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 mt-3">
                                <div class="form-group">
                                    <label for="no_details" class="">No. Details</label>
                                    <input id="no_details" type="text" name="no_details" class="form-control"
                                        value="{{ @$data->no_details }}">
                                </div>
                            </div>
