            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 layout-spacing">
                ...
                <div class="widget-content widget-content-area" style="overflow-x: auto; ">
                    ...
                    <form method="POST" class="p-5" id="addform" enctype="multipart/form-data"
                        action="{{ route('admin.header-pages.about-update', ['id' => $data->id]) }}">
                            @method('POST')
                            @CSRF
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="image-list">
                                        @foreach ($data->pageMedia as $media)
                                ...
                                <div class="col-md-12 mt-3">
                                    <div class="form-group">
                                        ...
                                        <textarea id="short_description" name="short_description"
                                            class="form-control">{{ @base64_decode($data->short_description) }}</textarea>
                                    </div>
                                </div> -->
